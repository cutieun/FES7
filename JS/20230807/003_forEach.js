...
// 문제7. 010-1234-2903번호가 있었을 때 아래와 같이 출력되게 해주세요. 뒤에 2자리를 x로 바꿔주세요.
// input = '010-1234-5678'
// output = '0xx-12xx-56xx'
'010-1234-5678'.split('-').forEach((v, i) => {
    console.log(v)
})
...
'010-4444-5678'.split('-').forEach((v, i) => {
    console.log(v.replace(v.slice(-2), 'xx'))
})  // 0xx xx44 56xx

'hello world hello'.replace('hello', 'jieun')   // 'jieun world hello'
